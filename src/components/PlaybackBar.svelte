...
<div on:click={openFullPlayback} class="flex h-full w-full justify-between px-2 cursor-pointer">
	<div class="flex-1 flex items-center">
		<p>{$playlist.scene.name}</p>
	</div>
	<div class="flex-1 flex justify-center">
		<svg class="h-4 self-start mt-2 text-gray-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8">
			<path d="M4 1L0 5l1.5 1.5L4 4l2.5 2.5L8 5 4 1z"/>
		</svg>
	</div>
